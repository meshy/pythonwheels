from svg_wheel import generate_svg_wheel, generate_svg
...
def main():
    ...
    # TODO: to think if I need those, since hard to tell which packge is a compiled one, maybe base on trove classifiers
    # wheel_types = ['manylinux1_py3', 'manylinux1_py2', 'win32_py3', 'win32_py2', 'win_amd64_py3', 'win_amd64_py2']
